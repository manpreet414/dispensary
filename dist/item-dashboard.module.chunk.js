    ...
    AddupdateItemComponent.prototype.fetch = function () {
        ...
        this._sharedService.get('getDispensary').then(function (res) {
            if (res.success) {
                ...
                _this.days.forEach(function (key) {
                    var obj = {
                        day: key,
                        startTime: '9:00AM',
                        closeTime: '5:00PM'
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__item_dashboard_routing_module__ = __webpack_require__("../../../../../src/app/item-dashboard/item-dashboard-routing.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__addupdate_item_addupdate_item_component__ = __webpack_require__("../../../../../src/app/item-dashboard/addupdate-item/addupdate-item.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__reviews_reviews_component__ = __webpack_require__("../../../../../src/app/item-dashboard/reviews/reviews.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__account_info_account_info_component__ = __webpack_require__("../../../../../src/app/item-dashboard/account-info/account-info.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__my_menu_my_menu_component__ = __webpack_require__("../../../../../src/app/item-dashboard/my-menu/my-menu.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__products_listing_products_listing_component__ = __webpack_require__("../../../../../src/app/item-dashboard/products-listing/products-listing.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    ItemDashboardModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_5__item_dashboard_routing_module__["a" /* ItemDashboardRoutingModule */]
            ],
            declarations: [__WEBPACK_IMPORTED_MODULE_6__addupdate_item_addupdate_item_component__["a" /* AddupdateItemComponent */], __WEBPACK_IMPORTED_MODULE_7__reviews_reviews_component__["a" /* ReviewsComponent */], __WEBPACK_IMPORTED_MODULE_8__account_info_account_info_component__["a" /* AccountInfoComponent */], __WEBPACK_IMPORTED_MODULE_9__my_menu_my_menu_component__["a" /* MyMenuComponent */], __WEBPACK_IMPORTED_MODULE_10__products_listing_products_listing_component__["a" /* ProductsListingComponent */]]
        })
    ], ItemDashboardModule);
...
var MyMenuComponent = /** @class */ (function () {
    function MyMenuComponent(_sharedService) {
        this._sharedService = _sharedService;
        this.products = [];
        this.categories = [];
    }
    ...
    MyMenuComponent.prototype.fetch = function () {
        var _this = this;
        this._sharedService.loader('show');
        this._sharedService.get('AllProductByUser').then(function (res) {
            _this._sharedService.loader('hide');
            if (res.success) {
                _this.products = res.data.key ? res.data.key : [];
                _this.getAllCategories();
            }
            else {
            }
        }, function (error) { _this._sharedService.loader('hide'); });
        this._sharedService.get('getDispensary').then(function (res) {
            if (res.success) {
                var object = res.data.key;
                _this.dispenaryID = object.id;
            }
            else {
            }
        }, function (error) { });
...
var ReviewsComponent = /** @class */ (function () {
    ...
    ReviewsComponent.prototype.fetch = function () {
        ...
        this._sharedService.get('reviews').then(function (res) {
            if (res.success) {
                _this.arrayObj = res.data.reviews;
