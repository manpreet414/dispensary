...
module.exports = "<!-- This is a Footer -->\n<footer>\n\t<div class=\"footer-top\">\n\t\t<div class=\"container\">\n\t\t\t<div class=\"row\">\n\t\t\t\t<div class=\"col-sm-3\">\n\t\t\t\t\t<h3>our contact</h3>\n\t\t\t\t\t<ul class=\"ft-1\">\n\t\t\t\t\t\t<li>\n\t\t\t\t\t\t\t<span><i class=\"fa fa-map-marker\" aria-hidden=\"true\"></i></span>\n\t\t\t\t\t\t\t<address>\n\t\t\t\t\t\t\t  1803 Bowness Rd NW,<br/>\n\t\t\t\t\t\t\t  Calgary, AB T2N 3K5<br/>\n\t\t\t\t\t\t\t</address>\n\t\t\t\t\t\t</li>\n\t\t\t\t\t\t<li>\n\t\t\t\t\t\t\t<span><i class=\"fa fa-phone\" aria-hidden=\"true\"></i></span>\n\t\t\t\t\t\t\t<address>\n\t\t\t\t\t\t\t\t(+587) 434 4794<br/>\n\t\t\t\t\t\t\t\t(+587) 434 4794\n\t\t\t\t\t\t    </address>\n\t\t\t\t\t\t</li>\n\t\t\t\t\t\t<li>\n\t\t\t\t\t\t\t<span><i class=\"fa fa-globe\" aria-hidden=\"true\"></i></span>\n\t\t\t\t\t\t\t<address>\n\t\t\t\t\t\t\t\tinfo@instaleaf.cs<br/>\n\t\t\t\t\t\t\t\twww.instaleaf.cs\n\t\t\t\t\t\t    </address>\n\t\t\t\t\t\t</li>\n\t\t\t\t\t</ul>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"col-sm-3\">\n\t\t\t\t\t<h3>partner with us</h3>\n\t\t\t\t\t<ul class=\"ft-2\">\n\t\t\t\t\t\t<li><a href=\"\">dispensaries</a></li>\n\t\t\t\t\t\t<li><a href=\"\">doctors</a></li>\n\t\t\t\t\t\t<li><a href=\"\">ambassador</a></li>\n\t\t\t\t\t</ul>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"col-sm-3\">\n\t\t\t\t\t<h3>help</h3>\n\t\t\t\t\t<ul class=\"ft-3\">\n\t\t\t\t\t\t<li><a href=\"\">faq</a></li>\n\t\t\t\t\t\t<li><a href=\"\">contact us</a></li>\n\t\t\t\t\t\t<li><a href=\"\">terms and condition</a></li>\n\t\t\t\t\t\t<li><a href=\"\">privacy policy</a></li>\n\t\t\t\t\t</ul>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"col-sm-3\">\n\t\t\t\t\t<h3>contact with us</h3>\n\t\t\t\t\t<ul class=\"ft-4\">\n\t\t\t\t\t\t<li><a href=\"\"><i class=\"fa fa-facebook\" aria-hidden=\"true\"></i></a></li>\n\t\t\t\t\t\t<li><a href=\"\"><i class=\"fa fa-linkedin\" aria-hidden=\"true\"></i></a></li>\n\t\t\t\t\t\t<li><a href=\"\"><i class=\"fa fa-instagram\" aria-hidden=\"true\"></i></a></li>\n\t\t\t\t\t\t<li><a href=\"\"><i class=\"fa fa-twitter\" aria-hidden=\"true\"></i></a></li>\n\t\t\t\t\t</ul>\n\t\t\t\t\t<div class=\"foot-subscribe EKDPS2032B-06011991\">\n\t\t\t\t\t\t<h4>subscribe</h4>\n\t\t\t\t\t\t<form action=\"\">\n\t\t\t\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" placeholder=\"Enter your email\" name=\"search\">\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn cus-btn cus-login\">submit</button>\n\t\t\t\t\t\t</form>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n\t<div class=\"footer-bottom\">\n\t\t<div class=\"container\">\n\t\t\t<div class=\"row\">\n\t\t\t\t<div class=\"col-sm-12 text-center\">\n\t\t\t\t\t<p class=\"copyright EKDPS2032B-06011991\"> 2018 ©  All rights reserved. <a href=\"\">privacy policy</a> | <a href=\"\">Terms of Use</a> | </p>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</footer>\n<!-- End Footer -->"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ngx_cookie__ = __webpack_require__("../../../../ngx-cookie/fesm5/ngx-cookie.js");
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(_router, _sharedService, _cookieService) {
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        ...
        this._router.events.subscribe(function (evt) {
            ...
            _this.token = _this._cookieService.get('token');
            _this.user = _this._cookieService.getObject('user') ? _this._cookieService.getObject('user') : {};
            // window.scrollTo(0, 0)
            if (_this.user) {
                var roles = _this.user.roles;
                _this.dashboard = roles == 'U' ? 'dashboard' : 'item-dashboard';
            }
        });
        this.token = this._cookieService.get('token');
        this.user = this._cookieService.getObject('user') ? this._cookieService.getObject('user') : {};
    };
    ...
    HeaderComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */],
            __WEBPACK_IMPORTED_MODULE_3__shared_services_shared_service__["a" /* SharedService */],
...
var LayoutComponent = /** @class */ (function () {
    function LayoutComponent(_router, _sharedService) {
        var _this = this;
        this._router = _router;
        this._sharedService = _sharedService;
...
var routes = [
    {
        ...
        children: [
            ...
            {
                path: 'item-dashboard',
                loadChildren: 'app/item-dashboard/item-dashboard.module#ItemDashboardModule'
            },
            {
                path: 'page',
