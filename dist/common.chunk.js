...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ngx_cookie__ = __webpack_require__("../../../../ngx-cookie/fesm5/ngx-cookie.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_ngx_flash_messages__ = __webpack_require__("../../../../ngx-flash-messages/lib-dist/flash-messages.module.js");
...
var SharedService = /** @class */ (function () {
    function SharedService(_router, _cookieService, _flashMessagesService, spinner, http) {
        this._router = _router;
        this._cookieService = _cookieService;
        this._flashMessagesService = _flashMessagesService;
        this.spinner = spinner;
        this.http = http;
        this.rootUrl = __WEBPACK_IMPORTED_MODULE_7__environments_environment__["a" /* environment */].config.BASE_URL;
        this.baseUrl = __WEBPACK_IMPORTED_MODULE_7__environments_environment__["a" /* environment */].config.API_URL;
    }
    SharedService.prototype.get = function (path) {
        var headers = this.getAuthorizationHeader();
        return this.http.get(this.rootUrl + path, { headers: headers })
            .toPromise().then(function (res) { return res.json(); });
    };
    SharedService.prototype.post = function (body, path) {
        var headers = this.getAuthorizationHeader();
    ...
    SharedService.prototype.myDispensary = function (search, page, count) {
        var headers = this.getAuthorizationHeader();
        return this.http.get(this.rootUrl + 'mydispensaries?search=' + search + '&page=' + page + "&count=" + count, { headers: headers })
            .toPromise().then(function (response) { return response.json(); });
    };
    SharedService.prototype.queryParams = function (path, options) {
        var headers = this.getAuthorizationHeader();
    ...
    SharedService.prototype.AllProductItemByCategory = function (AllProductItemByCategory, page, count) {
        var headers = this.getAuthorizationHeader();
        return this.http.get(this.rootUrl + 'AllProductItemByCategory?category_id=' + AllProductItemByCategory + '&page=' + page + "&count=" + count, { headers: headers })
            .toPromise().then(function (response) { return response.json(); });
    };
    SharedService.prototype.updateProducts = function (ID, body) {
        var headers = this.getAuthorizationHeader();
        var url = this.rootUrl + 'editItemProduct?=id' + ID + '&product_id' + body.product_id;
        return this.http.put(url, body, { headers: headers })
            .toPromise().then(function (response) { return response.json(); });
    };
    SharedService.prototype.getRoles = function () {
        return this._cookieService.get('roles');
    };
    /*This function is use to remove user session if Access token expired. */
    SharedService.prototype.checkAccessToken = function (err) {
        var code = err.code;
    ...
    SharedService.prototype.getAccessToken = function () {
    ...
    SharedService.prototype.showAlert = function (message, alertClass) {
        // window.scrollTo(0, 0);
        var obj = {
    ...
    SharedService = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */],
            ...
            __WEBPACK_IMPORTED_MODULE_9_ngx_flash_messages__["b" /* FlashMessagesService */],
...
__export(__webpack_require__("../../../../ng2-imageupload/src/image-upload.directive.js"));
__export(__webpack_require__("../../../../ng2-imageupload/src/image-upload.module.js"));
//# sourceMappingURL=index.js.map

/***/ }),

/***/ "../../../../ng2-imageupload/src/image-upload.directive.js":
/***/ (function(module, exports, __webpack_require__) {
...
var utils_1 = __webpack_require__("../../../../ng2-imageupload/src/utils.js");
...
/***/ "../../../../ng2-imageupload/src/image-upload.module.js":
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__("../../../core/esm5/core.js");
var image_upload_directive_1 = __webpack_require__("../../../../ng2-imageupload/src/image-upload.directive.js");
...
/***/ "../../../../ngx-flash-messages/lib-dist/flash-messages.component.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FlashMessagesComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__flash_messages_service__ = __webpack_require__("../../../../ngx-flash-messages/lib-dist/flash-messages.service.js");
...
FlashMessagesComponent.ctorParameters = function () { return [
    { type: __WEBPACK_IMPORTED_MODULE_1__flash_messages_service__["a" /* FlashMessagesService */], },
]; };
//# sourceMappingURL=flash-messages.component.js.map

/***/ }),

/***/ "../../../../ngx-flash-messages/lib-dist/flash-messages.module.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FlashMessagesModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("../../../common/esm5/common.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__flash_messages_service__ = __webpack_require__("../../../../ngx-flash-messages/lib-dist/flash-messages.service.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__flash_messages_component__ = __webpack_require__("../../../../ngx-flash-messages/lib-dist/flash-messages.component.js");
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_2__flash_messages_service__["a"]; });
/* unused harmony reexport FlashMessagesComponent */
...
FlashMessagesModule.decorators = [
    { type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"], args: [{
                ...
                providers: [
                    __WEBPACK_IMPORTED_MODULE_2__flash_messages_service__["a" /* FlashMessagesService */],
                ],
                declarations: [
                    __WEBPACK_IMPORTED_MODULE_3__flash_messages_component__["a" /* FlashMessagesComponent */],
                ],
                exports: [
                    __WEBPACK_IMPORTED_MODULE_3__flash_messages_component__["a" /* FlashMessagesComponent */],
                ]
...
/***/ "../../../../ngx-flash-messages/lib-dist/flash-messages.service.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FlashMessagesService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
...
var FlashMessagesService = (function () {
    function FlashMessagesService() {
        this.message = new __WEBPACK_IMPORTED_MODULE_1_rxjs_Subject__["Subject"]();
    }
